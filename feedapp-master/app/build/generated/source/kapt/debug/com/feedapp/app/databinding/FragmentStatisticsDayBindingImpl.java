...
public class FragmentStatisticsDayBindingImpl extends FragmentStatisticsDayBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.pieChart_container, 1);
        sViewsWithIds.put(R.id.date, 2);
        sViewsWithIds.put(R.id.pieChart, 3);
        sViewsWithIds.put(R.id.title, 4);
        sViewsWithIds.put(R.id.no_products, 5);
    ...
    public FragmentStatisticsDayBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 7, sIncludes, sViewsWithIds));
    }
    private FragmentStatisticsDayBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {

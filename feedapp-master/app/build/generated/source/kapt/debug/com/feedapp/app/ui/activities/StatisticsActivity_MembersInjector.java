...
public final class StatisticsActivity_MembersInjector
    implements MembersInjector<StatisticsActivity> {
  ...
  public static MembersInjector<StatisticsActivity> create(
      ...
      Provider<DispatchingAndroidInjector<android.app.Fragment>> frameworkFragmentInjectorProvider,
      Provider<ViewModelProvider.Factory> modelFactoryProvider) {
    return new StatisticsActivity_MembersInjector(
  ...
  public static void injectModelFactory(
      StatisticsActivity instance, ViewModelProvider.Factory modelFactory) {

...
public abstract class ActivityDietBinding extends ViewDataBinding {
  ...
  @NonNull
  public final FrameLayout linearColumnvolume;
  ...
  @Bindable
  protected DietVM mDietVM;

  protected ActivityDietBinding(Object _bindingComponent, View _root, int _localFieldCount,
      ...
      FrameLayout linearColumnvolume, LinearLayout linearRowfire, LinearLayout linearRowvector,
  ...
  public abstract void setDietVM(@Nullable DietVM dietVM);

  @Nullable
  public DietVM getDietVM() {
    return mDietVM;
  }
   ...
   * @Deprecated Use DataBindingUtil.inflate(inflater, R.layout.activity_diet, root, attachToRoot, component)
   */
  @NonNull
  @Deprecated
  public static ActivityDietBinding inflate(@NonNull LayoutInflater inflater,
      @Nullable ViewGroup root, boolean attachToRoot, @Nullable Object component) {
    return ViewDataBinding.<ActivityDietBinding>inflateInternal(inflater, R.layout.activity_diet, root, attachToRoot, component);
  }
   ...
   * compilation fails for another reason.
   * https://issuetracker.google.com/issues/116541301
   * @Deprecated Use DataBindingUtil.inflate(inflater, R.layout.activity_diet, null, false, component)
   */
  @NonNull
  @Deprecated
  public static ActivityDietBinding inflate(@NonNull LayoutInflater inflater,
      @Nullable Object component) {
    return ViewDataBinding.<ActivityDietBinding>inflateInternal(inflater, R.layout.activity_diet, null, false, component);
  }

  public static ActivityDietBinding bind(@NonNull View view) {
   ...
   */
  @Deprecated
  public static ActivityDietBinding bind(@NonNull View view, @Nullable Object component) {
    return (ActivityDietBinding)bind(component, view, R.layout.activity_diet);
  }
}

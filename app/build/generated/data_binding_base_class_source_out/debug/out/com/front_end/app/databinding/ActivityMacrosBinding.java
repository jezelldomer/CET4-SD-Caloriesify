...
public abstract class ActivityMacrosBinding extends ViewDataBinding {
  @NonNull
  ...
  @NonNull
  public final FrameLayout linearColumnairplane;
  ...
  @Bindable
  protected MacrosVM mMacrosVM;

  protected ActivityMacrosBinding(Object _bindingComponent, View _root, int _localFieldCount,
      ...
      ImageView imageVolume, LinearLayout linearColumn, FrameLayout linearColumnairplane,
      ...
      TextView txtBMI, TextView txtCreateyourCus, TextView txtDiet, TextView txtGoodMorningUS,
      TextView txtJournal, TextView txtLetsstartwit, TextView txtWorkout) {
  ...
  public abstract void setMacrosVM(@Nullable MacrosVM macrosVM);

  @Nullable
  public MacrosVM getMacrosVM() {
    return mMacrosVM;
  }

  @NonNull
  public static ActivityMacrosBinding inflate(@NonNull LayoutInflater inflater,
   ...
   * @Deprecated Use DataBindingUtil.inflate(inflater, R.layout.activity_macros, root, attachToRoot, component)
   */
  @NonNull
  @Deprecated
  public static ActivityMacrosBinding inflate(@NonNull LayoutInflater inflater,
      @Nullable ViewGroup root, boolean attachToRoot, @Nullable Object component) {
    return ViewDataBinding.<ActivityMacrosBinding>inflateInternal(inflater, R.layout.activity_macros, root, attachToRoot, component);
  }
   ...
   * compilation fails for another reason.
   * https://issuetracker.google.com/issues/116541301
   * @Deprecated Use DataBindingUtil.inflate(inflater, R.layout.activity_macros, null, false, component)
   */
  @NonNull
  @Deprecated
  public static ActivityMacrosBinding inflate(@NonNull LayoutInflater inflater,
      @Nullable Object component) {
    return ViewDataBinding.<ActivityMacrosBinding>inflateInternal(inflater, R.layout.activity_macros, null, false, component);
  }

  public static ActivityMacrosBinding bind(@NonNull View view) {
   ...
   */
  @Deprecated
  public static ActivityMacrosBinding bind(@NonNull View view, @Nullable Object component) {
    return (ActivityMacrosBinding)bind(component, view, R.layout.activity_macros);
  }
}

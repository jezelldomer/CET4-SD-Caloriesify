...
public abstract class ActivityWorkBinding extends ViewDataBinding {
  ...
  @NonNull
  public final FrameLayout linearColumnfire;
  ...
  @Bindable
  protected WorkVM mWorkVM;

  protected ActivityWorkBinding(Object _bindingComponent, View _root, int _localFieldCount,
      ...
      LinearLayout linearColumnfavorite, FrameLayout linearColumnfire,
  ...
  public abstract void setWorkVM(@Nullable WorkVM workVM);

  @Nullable
  public WorkVM getWorkVM() {
    return mWorkVM;
  }
   ...
   * @Deprecated Use DataBindingUtil.inflate(inflater, R.layout.activity_work, root, attachToRoot, component)
   */
  @NonNull
  @Deprecated
  public static ActivityWorkBinding inflate(@NonNull LayoutInflater inflater,
      @Nullable ViewGroup root, boolean attachToRoot, @Nullable Object component) {
    return ViewDataBinding.<ActivityWorkBinding>inflateInternal(inflater, R.layout.activity_work, root, attachToRoot, component);
  }
   ...
   * compilation fails for another reason.
   * https://issuetracker.google.com/issues/116541301
   * @Deprecated Use DataBindingUtil.inflate(inflater, R.layout.activity_work, null, false, component)
   */
  @NonNull
  @Deprecated
  public static ActivityWorkBinding inflate(@NonNull LayoutInflater inflater,
      @Nullable Object component) {
    return ViewDataBinding.<ActivityWorkBinding>inflateInternal(inflater, R.layout.activity_work, null, false, component);
  }

  public static ActivityWorkBinding bind(@NonNull View view) {
   ...
   */
  @Deprecated
  public static ActivityWorkBinding bind(@NonNull View view, @Nullable Object component) {
    return (ActivityWorkBinding)bind(component, view, R.layout.activity_work);
  }
}

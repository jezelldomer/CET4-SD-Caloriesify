...
public abstract class ActivityJournalBinding extends ViewDataBinding {
  ...
  @NonNull
  public final FrameLayout linearColumn;
  ...
  @NonNull
  public final FrameLayout linearColumnvector;
  ...
  @Bindable
  protected JournalVM mJournalVM;

  protected ActivityJournalBinding(Object _bindingComponent, View _root, int _localFieldCount,
      ...
      ImageView imageVolume, FrameLayout linearColumn, LinearLayout linearColumnairplane,
      ...
      LinearLayout linearColumnuser, FrameLayout linearColumnvector,
  ...
  public abstract void setJournalVM(@Nullable JournalVM journalVM);

  @Nullable
  public JournalVM getJournalVM() {
    return mJournalVM;
  }
   ...
   * @Deprecated Use DataBindingUtil.inflate(inflater, R.layout.activity_journal, root, attachToRoot, component)
   */
  @NonNull
  @Deprecated
  public static ActivityJournalBinding inflate(@NonNull LayoutInflater inflater,
      @Nullable ViewGroup root, boolean attachToRoot, @Nullable Object component) {
    return ViewDataBinding.<ActivityJournalBinding>inflateInternal(inflater, R.layout.activity_journal, root, attachToRoot, component);
  }
   ...
   * compilation fails for another reason.
   * https://issuetracker.google.com/issues/116541301
   * @Deprecated Use DataBindingUtil.inflate(inflater, R.layout.activity_journal, null, false, component)
   */
  @NonNull
  @Deprecated
  public static ActivityJournalBinding inflate(@NonNull LayoutInflater inflater,
      @Nullable Object component) {
    return ViewDataBinding.<ActivityJournalBinding>inflateInternal(inflater, R.layout.activity_journal, null, false, component);
  }

  public static ActivityJournalBinding bind(@NonNull View view) {
   ...
   */
  @Deprecated
  public static ActivityJournalBinding bind(@NonNull View view, @Nullable Object component) {
    return (ActivityJournalBinding)bind(component, view, R.layout.activity_journal);
  }
}

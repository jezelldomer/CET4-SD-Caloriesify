...
>>>>>>> 7debd9c21c9b9e51d6cb8a7946f6c7275b1731e8
   ...
   */
<<<<<<< HEAD
  var txtLanguage: String? = MyApp.getInstance().resources.getString(R.string.msg_net_carbs_16)
=======
  var txtLanguageOne: String? = MyApp.getInstance().resources.getString(R.string.msg_net_carbs_16)
>>>>>>> 7debd9c21c9b9e51d6cb8a7946f6c7275b1731e8
  ,
  /**
   * TODO Replace with dynamic value
   */
  var txtTen: String? = MyApp.getInstance().resources.getString(R.string.lbl9)
  ,
  /**
   * TODO Replace with dynamic value
   */
  var txtExercise: String? = MyApp.getInstance().resources.getString(R.string.lbl_exercise)
  ,
  /**
   * TODO Replace with dynamic value
   */
  var txtTime: String? = MyApp.getInstance().resources.getString(R.string.msg_recommended_30)
  ,
  /**
   * TODO Replace with dynamic value
   */

...
class DinnerActivity : BaseActivity<ActivityDinnerBinding>(R.layout.activity_dinner) {
  ...
  private val REQUEST_CODE_LUNCH_ACTIVITY: Int = 747


  private val REQUEST_CODE_BREAKFAST_ACTIVITY: Int = 770


  private val REQUEST_CODE_WATER_ACTIVITY: Int = 400


  private val REQUEST_CODE_EXCER_ACTIVITY: Int = 500


  private val REQUEST_CODE_SNACKS_ACTIVITY: Int = 666
